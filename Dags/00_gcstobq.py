...
with DAG(
    ...
    load_csv_to_bigquery = GCSToBigQueryOperator(
        ...
        bucket='buc-src-global-data',  # Replace with your bucket name
        source_objects=['global_health_data.csv'],  # Path to your file in the bucket
        destination_project_dataset_table='blissful-sun-454709-u9.staging_dataset.global_data',  # Replace with your project, dataset, and table name
        source_format='CSV', 
